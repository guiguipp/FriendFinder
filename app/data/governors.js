...
var johnson8 = new Stances (
    ...
    My Administration will put a moratorium on light rail and focus transit money on a first-class bus system.  In the Metro, I’ll base my transportation funding decisions on projects that relieve congestion and provide mobility to the citizens of Minnesota.`
    )
    johnsonStances.push(johnson8)

var johnson9 = new Stances (
...
var stephens1 = new Stances (
    ...
    stephenStances.push(stephens1)

var stephens2 = new Stances (
    `Education`,
    ...
    stephenStances.push(stephens2)

var stephens3 = new Stances (
    `Natural Resources`,
    ...
    stephenStances.push(stephens3)

var stephens4 = new Stances (
    `Health Care`,
    ...
    stephenStances.push(stephens4)

var stephens5 = new Stances (
    `Transportation`,
    ...
    stephenStances.push(stephens5)

var stephens6 = new Stances (
    `Spending`,
    ...
    stephenStances.push(stephens6)

var stephens7 = new Stances (
    `Taxes`,
    ...
    stephenStances.push(stephens7)

var stephens8 = new Stances (
    `Second Amendment`,
    ...
    stephenStances.push(stephens8)

var stephens9 = new Stances (
    `Life`,
    `I believe God creates all life, and in the sanctity of life from conception until natural death.`
    )
    stephenStances.push(stephens9)

var parrish1 = new Stances (
    `Top Priority`,
